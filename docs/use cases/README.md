...
@startuml
    ...
    usecase "Керувати\nдозволами" as PermissionsManage #ffcccb

    usecase "Заблокувати\nкористувача" as BlockUser
    usecase "Розблокувати\nкористувача" as UnblockUser
    usecase "Відповісти\nна запит користувача" as RespondUserRequest #ffcccb
...
| ВИКЛЮЧНІ СИТУАЦІЇ                      | `AddMemner_AccountNotFound`<br>обліковий запис не знайдено |
...
|#f3e5f5|Проєктний менеджер|
start;

:Натискає на кнопку "Видалити учасника";

|#ffe4e1|Система|
:Відкриває сторінку зі списком для\nвибору учасника, якого потрібно видалити;
...
|Система|
:Перевіряє існування облікового запису з даним ім'ям;
...
:Оновлює список учасників всіх проєктів, у яких брав участь даний користувач;

|Адміністратор|
:Отримує підтвердження про успішне заблокування користувача;
...
|Адміністратор|
:Натискає на кнопку "Розблокувати користувача";
...
|Адміністратор|
:Отримує підтвердження про успішне розблокування користувача;
